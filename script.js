  ...
  if (!active) { active = true; const animate = ev => {
      ...
      if (active) {
        ...
        setTimeout(() => {
          ...
          main_title.innerHTML = '<h1> Mecánico y Electricista </h1>'
      ...
      /* one */ ev => {
        if (!active_view[0]) {
          const text = `<div><br>
            ...
            "> Edwin Agudelo </h2>
            <i>y soy:</i><br>
            <i style="font-size: 1.7em;">· soldador ·</i><br>
            <i style="font-size: 1.7em;">· mecánico ·</i><br>
            <i style="font-size: 1.8em">· electricista ·</i><br>
            <i style="
              color: rgba(255, 217, 0, 8);
              font-size: 1.8em;
            "> instalador de: </i><br>
            <div style="font-size: 1.1em;">
              <i>· luces de lujo ·</i><br>
              <i>· exploradoras ·</i><br>
              <i>· radios y parlantes ·</i><br>
